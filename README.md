...
该手势库是以业务中常用的贴纸类型做为基础，参考 `AlloyTouch`(感谢...), 进行进一步的封装抽象，更贴近我们业务，更加便于使用，更加轻量以及有更好的业务定制性，希望大家多多提意见哈；该库去除了一些比较少用到的手势，使代码更加精简和轻量，没有依赖，压缩后大小约为10K；
...
##### 2.直接通过`script`标签引入,挂载在全局 **MTPlugin.MTouch** 下;
